var PrayerTimes = function() {
	...
	PrayerTimes.prototype.computePrayerTimes = function(times) {
		...
		// var  ishraq   = this.sunAngleTime(this.eval(params.ishraq), times.ishraq, 'ccw');
		var sunrise = this.sunAngleTime(this.riseSetAngle(), times.sunrise, 'ccw');
		// var ishraq = this.sunAngleTime(this.riseSetAngle(), times.ishraq, 'ccw');
		...
		return {
			imsak: imsak, fajr: fajr, sunrise: sunrise,ishraq: sunrise+.13, dhuhr: dhuhr,
